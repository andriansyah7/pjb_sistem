...
@section('container')
    ...
    <div class ="card card-info card-outline col-13">
        ...
        <div class="card-body">
          <form action="{{route('simpan-history')}}" method="post">
          @csrf
         
          <div class="row">
            <div class="form-group col-sm-7">
            <label>SERP TAHUN</label>
              <input type="text" name="history_serp_tahun" class="form-control @error('history_serp_tahun') is-invalid @enderror" value="{{$history}}">
              @error('history_serp_tahun') <div class="invalid-feedback"> {{$message}} </div> @enderror
            </div>
            </div>
