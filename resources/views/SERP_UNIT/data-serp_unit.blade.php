            ...
            <div class="card-body">
              <table id="#example2" class="table table-bordered table-striped myTable">
                ...
                <tr>
                    ...
                    <td>
                      <a href="{{route('edit-serp_unit',$item->serp_unit_id)}}"><i class="fas fa-edit"></i></a> 
                      |
                      <a href="{{route('delete-serp_unit',$item->serp_unit_id)}}"><i onclick="return confirm('Yakin hapus data?')" class="fas fa-trash-alt" style="color: red"></i></a>
                    </td>
                </tr>
                @endforeach
                </tbody>
